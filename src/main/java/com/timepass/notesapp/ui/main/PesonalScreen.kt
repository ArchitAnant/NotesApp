...
@Composable
fun PersonalScreen(viewModel: ViewModel) {
    var openDialog by remember {
        mutableStateOf(
            false)
    }
    val listOfNotes = viewModel.personalList.collectAsState().value
    Scaffold(
        floatingActionButton = {
            FabButton (
                fabButtonColor = personalColor
            ){
        ...
        InsidePersonalScreen(listOfNotes = listOfNotes,
            addNote = {
                viewModel.addNote(it)
            },
            onUpdateClick = {id,name,detail->
...
@Composable
fun InsidePersonalScreen(listOfNotes:List<Notes>,
                         addNote:(Notes)->Unit,
                         onUpdateClick:(id:String,name:String,detail:String)->Unit,
                    ...
                    NotesItem(note = it,
                        ...
                        onSubmitClick = { note, name, detail ->
                            if(note==null){
                                ...
                                onUpdateClick(note.docId,name,detail)
                            }
